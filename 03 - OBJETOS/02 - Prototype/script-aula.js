...
console.log(renan.prototype); // undefined
...
protótipo deste construtor. 
Lembrando, prototype é uma propriedade de funções apenas.
*/

const wesla = new Pessoa('Wesla', 32)
...
criar este objeto. O objeto abaixo possui acesso a métodos que nunca definimos, mas são herdados 
...
Os métodos e propriedades acessado com o . são referentes ao tipo de dados que é 
